            ...
            <span class="navbar-brand">
                ...
                switch ($cur_menu) {
                    ...
                    case "my_save_search":
                        ...
                        break;
                    case "my_agents":
                        esc_html_e('Agents', 'essential-real-estate');
                        break;
                }
                ?>
            </span>
        ...
        <div class="collapse navbar-collapse" id="ere-dashboard-sidebar-navbar-collapse">
            <ul class="nav navbar-nav ere-dashboard-nav">
                <?php if ($permalink = ere_get_permalink('my_profile')) : ?>
                    <li<?php if ($cur_menu == 'my_profile' && empty($page)) echo ' class="active"' ?>>
                ...
                <?php endif; ?>
                    ...
                    <?php if ($permalink = ere_get_permalink('my_profile')) : ?>
                    <li<?php if (!empty($page)) echo ' class="active"' ?>>
                        <a href="<?php echo $permalink.'#pinter'; ?>"><i
                                class="fa fa-user"></i><?php esc_html_e('Agents', 'essential-real-estate'); ?>
                        </a>
                    </li>
                <?php endif; ?>
